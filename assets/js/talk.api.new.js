...
class TalkAPI {
    ...
    createButton(id, voice) {
        ...
        button.innerHTML = this.getSpeakerIcon() + 'Listen';
    ...
    handleButtonClick(button) {
        ...
        if (this.currentButton === button && this.currentAudio) {
            if (this.currentAudio.paused) {
                ...
                button.innerHTML = this.getPauseIcon() + 'Pause';
            } else {
                // Pause playback
                console.log('Pausing audio');
                this.currentAudio.pause();
                button.innerHTML = this.getPlayIcon() + 'Resume';
            }
            return;
        }
        ...
        // Update button state
        button.innerHTML = this.getLoadingIcon() + 'Loading...';
    ...
    stopCurrentAudio() {
        ...
        if (this.currentButton) {
            this.currentButton.innerHTML = this.getSpeakerIcon() + 'Listen';
    ...
    async playAudio(text, voice, button, elements) {
        try {
            ...
            audio.onerror = () => {
                ...
                button.innerHTML = this.getErrorIcon() + 'Error';
                setTimeout(() => {
                    button.innerHTML = this.getSpeakerIcon() + 'Retry';
                    button.disabled = false;
                }, 2000);
                this.currentAudio = null;
                this.currentButton = null;
